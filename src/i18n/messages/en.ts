...
export const en = {
  ...
  // ── Workbench ───────────────────────────────────────────────────────────
  "workbench.operationsWorkspace": "Operations workspace",
  "workbench.dashboard": "Workbench dashboard",
  "workbench.description":
    "Organization-level daily additions, workstation mapping, and reward rules.",
  "workbench.openDisplay": "Open Workbench display",
  "workbench.display": "Display",
  "workbench.operationsDisplay": "Workbench operations display",
  "workbench.loadingReplay": "Loading 3D Replay...",
  "workbench.fullscreenReplay": "Fullscreen view · 3D Replay enabled",
  "workbench.fullscreenOperations": "Fullscreen operations view",
  "workbench.replayLoadError":
    "3D Replay could not be loaded; Display opened without it.",
  "workbench.controlCenter": "Control center",
  "workbench.dashboardControls": "Dashboard controls",
  "workbench.controlHint":
    "Adjust the reporting window, refresh local data, or manage Workbench rules.",
  "workbench.reportingDays": "{count} reporting days",
  "workbench.dataUpdatedThrough": "Data updated through {date}",
  "workbench.sources": "Sources",
  "workbench.startDate": "Start date",
  "workbench.endDate": "End date",
  "workbench.quickRange": "Quick range",
  "workbench.today": "Today",
  "workbench.yesterday": "Yesterday",
  "workbench.last7Days": "Last 7 days",
  "workbench.thisWeek": "This week",
  "workbench.lastWeek": "Last week",
  "workbench.actions": "Actions",
  "workbench.resetRange": "Reset range",
  "workbench.reloadLocalData": "Reload local data",
  ...
  "workbench.datasetsAwaitingDate":
    "Workbench datasets awaiting date confirmation",
  "workbench.datePending": "Date pending",
  "workbench.datePendingDetail":
    "{count} datasets have no capture-date evidence. They remain in source totals but are excluded from a specific date range.",
  "workbench.viewPendingPaths": "View datasets awaiting confirmation",
  ...
  "workbench.liveSnapshot": "Live snapshot",
  "workbench.operationsOverview": "Operations overview",
  "workbench.overviewHint":
    "Organization totals and selected-range performance at a glance.",
  "workbench.overview": "Overview",
  "workbench.selectedRangeSnapshot": "Selected range snapshot",
  "workbench.organizationTotalHours": "Organization total hours",
  "workbench.selectedRangeHours": "Selected range hours",
  "workbench.dailyTargetHours": "Daily target hours",
  "workbench.totalBonus": "Total bonus",
  "workbench.sourcesCount": "Sources",
  "workbench.daysInRange": "Days in range",
  "workbench.noGroupedRows": "No grouped rows",
  "workbench.filterWorkstationRows": "Filter workstation rows",
  "workbench.sortWorkstationRows": "Sort workstation rows",
  "workbench.workstationHours": "Workstation Hours",
  "workbench.perPersonTargetHours": "Per-person target hours",
  "workbench.noPersonnelMapping": "No personnel mappings are configured.",
  "workbench.personnelBonusTotal": "Personnel bonus total",
  "workbench.noWorkstationRows": "No workstation rows",
  "workbench.unassigned": "Unassigned",
  "workbench.noWorkstationAdditions": "No workstation additions in this range",
  "workbench.pageWorkstations": "Page {page} / {pages} · {count} workstations",
  "workbench.noPersonnelRows": "No personnel rows",
  "workbench.personnelCount": "{count} personnel",
  "workbench.loadingChecks": "Loading task metadata and custom checks…",
  ...
  "workbench.tacCapVideo": "TacCap Video",
  "workbench.showcaseFirst20": "Showcase · First 20 seconds",
  ...
  "workbench.statusFail": "FAIL",
  "workbench.statusWarn": "WARN",
  "workbench.statusSkip": "SKIP",
  "workbench.statusPass": "PASS",
  "workbench.robotId": "Robot ID: {id}",
  "workbench.sourceRepos": "Source repos",
  "workbench.datasets": "Datasets",
  "workbench.downloads": "Downloads",
  "workbench.target": "Target",
  "workbench.rate": "Rate",
  "workbench.rule": "Rule",
  "workbench.avgPerEpisode": "Avg / ep",
  "workbench.reward": "Reward",
  "workbench.personnel": "Personnel",
  "workbench.email": "Email",
  "workbench.workstation": "Workstation",
  "workbench.avgHours": "Avg hours",
  "workbench.rateTitle": "Per-person hours",
  "workbench.workstationDetail": "Workstation detail",
  "workbench.personnelWorkload": "Personnel workload",
  "workbench.personnelWorkloadHint":
    "Average personnel hours equal Workstation hours divided by Original collectors. Contribution weights are used only for quality bonuses.",
  "workbench.workstationDayHeatmap": "Workstation day heatmap",
  "workbench.rangeNoDate": "No date range available",
  "workbench.beginning": "Beginning",
  "workbench.latest": "Latest",
  "workbench.snapshot": "Snapshot {date}",
  "workbench.unassignedHours":
    "{hours} of workstation hours are not assigned to personnel.",
  "workbench.previousChapter": "Previous chapter",
  "workbench.resumeDisplay": "Resume display",
  "workbench.pauseDisplay": "Pause display",
  "workbench.nextChapter": "Next chapter",
  "workbench.exitDisplay": "Exit display",
  "workbench.displayProgress": "Display chapter progress",
  "workbench.resumeShortcut": "Resume (Space)",
  "workbench.pauseShortcut": "Pause (Space)",
  "workbench.previousShortcut": "Previous chapter (Left arrow)",
  "workbench.nextShortcut": "Next chapter (Right arrow)",
  "workbench.exitShortcut": "Exit display (Esc)",
  "workbench.paused": "Paused",
  "workbench.episodeMeta": "Episode {episode} · {fps} FPS · {seconds}s window",
  "workbench.sort": "Sort",
  "workbench.recentlyUpdated": "Recently updated",
  "workbench.recentlyCreated": "Recently created",
  "workbench.sortTacVerse": "Sort TacVerse datasets",
  "workbench.datasetStatistics": "Dataset statistics/TacVerse",
  "workbench.hubCatalogVisible":
    "Hub catalog visible to the current credential",
  "workbench.refreshed": "refreshed {date}",
  "workbench.notRefreshed": "not refreshed yet",
  "workbench.issuesOnly": "Issues only",
  "workbench.filterDatasetStatistics": "Filter TacVerse dataset statistics",
  "workbench.datasetFilterPlaceholder": "Filter by dataset name or robot_type",
  ...
  "workbench.unavailableMetadata": "Statistics metadata is unavailable.",
  "workbench.metricsPartial": "partial",
  "workbench.metricsUnavailable": "unavailable",
  "workbench.robotTypeWarning": "robot_type warning",
  "workbench.robotTypes": "{count} robot types",
  "workbench.noDatasetMatch": "No datasets match the current filters.",
  "workbench.drilldown": "Drilldown",
  "workbench.createReviewTask": "Create review task",
  "workbench.close": "Close",
  "workbench.openEpisode": "Open episode {episode}",
  "workbench.frame": "frame {frame}",
  "workbench.noDatasetAdditions": "No dataset additions match this selection.",
  "workbench.mappingEditorHint":
    "Workstation rows are aggregated above; edits here remain device-level and use collector serial or robot_id. Existing legacy mappings are preserved for compatibility.",
  "workbench.deviceId": "Device ID",
  "workbench.showingDatasets":
    "Showing {shown} of {category} datasets in this category · {total} total in the TacVerse Hub catalog",
  "workbench.downloaded": "Downloaded",
  "workbench.incomplete": "Incomplete",
  "workbench.localMissing": "Missing",
  "workbench.statisticsLoadFailed": "Dataset statistics could not be loaded",
  "workbench.statisticsIncomplete":
    "The dataset statistics response was incomplete.",
  "workbench.retry": "Retry",
  "workbench.personnelMappingDate": "Personnel mapping date",
  "workbench.discardMappingChanges":
    "Discard unsaved personnel mapping changes?",
  "workbench.savedFor": "Saved for {date}",
  "workbench.inheritedPrevious": "Inherited from previous date",
  "workbench.inheritedFrom": "Inherited from {date}",
  "workbench.noPreviousMapping": "No previous mapping",
  "workbench.mappingHint":
    "Each row binds one workstation to one person. Set the original collector count once per workstation; unconfigured dates copy the latest earlier mapping automatically.",
  "workbench.reset": "Reset",
  "workbench.followPreviousDate": "Follow previous date",
  "workbench.saveDate": "Save {date}",
  "workbench.saving": "Saving…",
  "workbench.originalCollectors": "Original collectors",
  "workbench.action": "Action",
  "workbench.remove": "Remove",
  "workbench.addMapping": "Add mapping",
  "workbench.workstationPlaceholder": "Workstation",
  "workbench.mappingWorkstationPlaceholder": "A2",
  "workbench.mappingWorkstationAria": "Mapping {index} workstation",
  "workbench.mappingPersonnelAria": "Mapping {index} personnel",
  "workbench.mappingEmailAria": "Mapping {index} email",
  "workbench.mappingCollectorCountAria":
    "Mapping {index} original collector count",
  "workbench.mappingSaved": "Personnel mapping saved for {date}.",
  "workbench.mappingInherited":
    "Personnel mapping for {date} now follows the previous date.",
  "workbench.workstationRequired":
    "Workstation is required for every personnel mapping.",
  "workbench.collectorCountPositive":
    "Original collector count for {workstation} must be a positive integer.",
  "workbench.emailConsistent":
    "Email for {personnel} must be consistent across mappings.",
  "workbench.collectorCountConsistent":
    "Original collector count for {workstation} must be consistent across personnel mappings.",
  "workbench.personnelAttributionIncomplete":
    "Personnel attribution incomplete: {hours} h cannot be assigned.",
  "workbench.sharedState": "Shared Workbench state",
  "workbench.publicDataset": "Public dataset",
  "workbench.sharedDescription":
    "Workstation mappings, personnel mapping (including email), reward rules, and Workbench/TacFlow run logs.",
  "workbench.notSynchronized": "Not synchronized yet",
  "workbench.lastSync": "Last sync {date}",
  "workbench.lastSyncUnavailable": "Last sync unavailable",
  "workbench.pendingLogs": "{count} pending log(s)",
  "workbench.writeTokenAvailable": "HF write token available",
  "workbench.publicReadOnly": "Public read-only mode",
  "workbench.syncError": "Unable to synchronize shared Workbench state.",
  "workbench.dataset": "Dataset",
  "workbench.updated": "Updated",
  "workbench.local": "Local",
  "workbench.syncing": "Syncing",
  "workbench.syncNow": "Sync now",
  "workbench.saveFailed": "Unable to save ({status}).",
  ...
  "workbench.note": "Email note",
  "workbench.notePlaceholder":
    "Optional; the note appears in both the HTML email and plain-text fallback.",
  "workbench.preview": "Email preview",
  "workbench.previewTitle": "Workbench HTML email preview",
  "workbench.noPreview":
    "No email generated. Generate a preview before sending.",
  "workbench.generatePreview": "Generate/refresh preview",
  "workbench.send": "Send",
  "workbench.recipientSelection": "Recipients (multiple selection)",
  "workbench.shortcutGroup": "Shortcut group",
  "workbench.chooseGroup": "Choose a group to fill recipients",
  "workbench.mergeRecipients":
    "Selected emails are merged into recipients; you can select again.",
  "workbench.selectPersonnel": "You can also select personnel directly",
  "workbench.xrWorkstation": "XR workstation",
  ...
  "workbench.repos": "{count} repos",
  "workbench.viewRepos": "View {count} source repos",
  "workbench.view": "View",
  "workbench.copyRepoHint":
    "Click a dataset name to copy its full repository id",
  "workbench.autoRange": "Auto range",
  "workbench.noPersonnelMappingShort": "No personnel mapping",
  "workbench.legacyOnly": "Legacy only",
  "workbench.collectorSn": "collector SN",
  "workbench.robotIdSource": "robot_id",
  "workbench.leftSn": "left SN",
  "workbench.legacyMappingWarning":
    "Existing legacy left SN mappings are still loaded for compatibility; new workstation edits should use robot_id.",
  "workbench.rewardRulesHint":
    "Thresholds are expressed as completion percentage against the selected range target.",
  "workbench.enabled": "Enabled",
  "workbench.restoreDefaults": "Restore defaults",
  "workbench.importDefaults": "Import defaults",
  "workbench.addLevel": "Add level",
  "workbench.label": "Label",
  "workbench.minPercent": "Min %",
  "workbench.maxPercent": "Max %",
  "workbench.amount": "Amount",
  "workbench.minSeconds": "Min seconds",
  "workbench.maxSeconds": "Max seconds",
  "workbench.multiplier": "Multiplier",
  "workbench.openEnded": "Open",
  "workbench.dailyTargetLabel": "Daily target",
  "workbench.saveFailedGeneric":
    "Unable to save Workbench settings ({status}).",
  "workbench.mappingsSaved": "Workstation mappings saved.",
  "workbench.rewardRulesSaved": "Reward rules saved.",
  "workbench.reviewTaskCreated": "Review task created in this browser.",
  "workbench.reviewTaskFailed": "Unable to create review task.",
  "workbench.shareLinkCopied": "Share link copied.",
  "workbench.shareLinkFailed": "Unable to copy share link.",
  "workbench.csvExported": "CSV exported.",
  "workbench.dated": "Dated",
  "workbench.category": "Category",
  "workbench.allDatasets": "All datasets",
  "workbench.panelTitle": "Workbench",
  "workbench.panelDescription":
    "Read-only dataset statistics and Workbench custom checks. Doctor and Parquet remain independent.",
  "workbench.refreshChecks": "Refresh checks",
  "workbench.refreshStatistics": "Refresh statistics",
  "workbench.refreshingStatistics": "Refreshing statistics…",
  "workbench.refreshingStatsMetadata":
    "Refreshing statistics metadata from Hugging Face…",
  "workbench.sourceRequired": "Select a data source first.",
  "workbench.noSources": "No data sources",
  "workbench.sourceDownloadHint":
    "For bulk dataset downloads, use the native Source panel below: “Sync from Hugging Face”.",
  "workbench.hub": "Hub",
  "workbench.huggingFaceEndpoint": "Hugging Face endpoint",
  "workbench.huggingFaceControls": "Workbench Hugging Face controls",
  "workbench.authenticated": "authenticated",
  "workbench.tokenConfigured": "HF token configured (not checked)",
  "workbench.notSignedIn": "HF: not signed in",
  "workbench.signedIn": "Signed in",
  "workbench.visibleDatasets": "Visible datasets: {count}",
  "workbench.changeToken": "Change token",
  "workbench.hfToken": "HF token",
  "workbench.tokenRequired": "Enter a Hugging Face token.",
  "workbench.tokenVerifyFailed": "Token verification failed.",
  "workbench.logoutFailed": "Unable to sign out of HF.",
  "workbench.checkAccount": "Check account",
  "workbench.checkingAccount": "Checking account…",
  "workbench.clearLocalToken": "Clear local token",
  "workbench.mirrorHint":
    "hf-mirror.com may not serve metadata files. Use huggingface.co when Refresh statistics needs to download stats JSON.",
  "workbench.verifySave": "Verify and save",
  "workbench.verifying": "Verifying…",
  "workbench.tokenHelp":
    "The token is sent only to this local backend and saved under .xense-viewer/secrets after successful verification.",
  "workbench.refreshingHubCatalog": "Refreshing Hub catalog",
  "workbench.syncingStatsFiles": "Syncing stats files",
  "workbench.statisticsRefreshComplete": "Statistics refresh complete",
  "workbench.statisticsRefreshFailed": "Statistics refresh failed",
  "workbench.statisticsRefreshFailedStatus":
    "Statistics refresh failed ({status}).",
  "workbench.statisticsStreamMissing": "Statistics refresh returned no stream.",
  "workbench.catalogCacheRefreshed": "Statistics cache refreshed.",
  "workbench.waitingProgress": "Waiting for progress events…",
  "workbench.metaFiles": "Meta files {done} / {total}",
  "workbench.resolvingMetaFiles": "Resolving meta file list…",
  ...
  "workbench.mergedCategory": "TacVerse/taccap-g1 · Merged",
  "workbench.folderRepositories": "Folder repositories",
  "workbench.otherDatasets": "Other datasets",
  "workbench.datasetStatisticsTitle": "Dataset Statistics",
  "workbench.datasetStatisticsHint":
    "Summary derived from meta/info.json and episode metadata.",
  "workbench.loadingEpisodeMetadata": "Loading episode metadata…",
  "workbench.totalEpisodes": "Total Episodes",
  "workbench.totalFrames": "Total Frames",
  "workbench.recordingTime": "Recording Time",
  "workbench.averageEpisode": "Average Episode",
  "workbench.datasetSize": "Dataset Size",
  "workbench.fps": "FPS",
  "workbench.robotType": "Robot Type",
  "workbench.episodeStatsFailed": "Episode statistics could not be loaded",
  "workbench.retryStatistics": "Retry statistics",
  "workbench.computingEpisodeDistribution":
    "Computing episode length distribution…",
  "workbench.episodeLengthDistribution": "Episode Length Distribution",
  "workbench.episodeDetails": "Episode Details",
  "workbench.episodesInRange": "{count} episodes",
  "workbench.failedChecks": "{count} failed",
  "workbench.warningChecks": "{count} warnings",
  "workbench.allChecksPassed": "All custom checks passed",
  "workbench.episode": "Episode",
  "workbench.duration": "Duration",
  "workbench.expandDurationRange": "expand a duration range",
  "workbench.showingFirstEpisodes":
    "Showing the first {count} episodes; {more} more are in this range.",
  "workbench.episodeDurationUnavailable":
    "Episode duration metadata is unavailable for this dataset version.",
  "workbench.customChecks": "Custom Checks",
  "workbench.customChecksHint":
    "Workbench rules only: name format, average duration, and prompt quality. PICO MoTracker is intentionally excluded.",
  "workbench.taskPromptsLoaded": "{count} task prompts loaded",
  "workbench.averageDurationTarget": "Average duration target: {min}–{max}s",
  "workbench.promptTarget": "Prompt target: {min}–{max} words",
  "workbench.detail_one": "{count} detail",
  "workbench.detail_other": "{count} details",
  "workbench.customChecksNotRun": "Custom checks have not run yet.",
  "workbench.catalogRefreshed": "Catalog refreshed.",
  "workbench.catalogRefreshedCount":
    "Catalog refreshed: {count} datasets visible to the current credential.",
  "workbench.statsAlreadyCurrent": "Stats files are already up to date.",
  "workbench.statsSynced": "Stats files synced: {count} datasets.",
  "workbench.statsSyncedWithFailures":
    "Stats files synced: {count} datasets, {failed} failed.",
  "workbench.archived":
    "Archived {repos} removed datasets and {snapshots} meta snapshots ({files} files){suffix}",
  "workbench.archiveFailureSuffix": "; {count} archive operations failed.",
  "workbench.statisticsRefreshFailedFallback": "Statistics refresh failed.",
  "workbench.accountCheckFailed": "HF account check failed.",
  "workbench.clearTokenFailed": "Unable to clear HF token.",
  "workbench.localChecksOnly":
    "Custom checks are available only for local datasets.",
  "workbench.organizationRequired":
    "Workbench statistics requires a dataset organization.",
  "workbench.statisticsResponseIncomplete":
    "Workbench statistics response is incomplete.",
  "workbench.scanErrors":
    "{count} dataset paths could not be scanned. The visible rows are still grouped.",
  ...
  "workbench.sourceUnclassified": "TacVerse/Unconfirmed",
  "workbench.episodeDurationMultiplier": "Episode duration multiplier",
  "workbench.dailyTargetPositive": "Daily target hours must be greater than 0.",
  "workbench.addRewardLevel": "Add at least one reward level.",
  "workbench.firstLevelZero": "The first level must start at 0%.",
  "workbench.thresholdsInvalid": "Level thresholds must be valid numbers.",
  "workbench.amountsInvalid": "Level amounts must be valid numbers.",
  "workbench.onlyLastOpen": "Only the last level can be open-ended.",
  "workbench.levelRangesContinuous": "Level ranges must be continuous.",
  "workbench.durationStartZero":
    "Episode duration levels must start at 0 seconds.",
  "workbench.durationMultipliersPositive":
    "Episode duration multipliers must be positive numbers.",
  "workbench.durationRangesContinuous":
    "Episode duration ranges must be continuous.",
  "workbench.durationLastOpen":
    "The last episode duration level must be open-ended.",
  "workbench.filter": "Filter",
  "workbench.latestDataDays": "latest data days",
  "workbench.noWorkstationDayDataFrom":
    "No workstation day data is available from {date} through the selected end date ({end}).",
  "workbench.workstationDetailHint":
    "Rows follow the selected statistics scope and workstation mappings.",
  "workbench.rowFilterPlaceholder": "robot, workstation, dataset…",
